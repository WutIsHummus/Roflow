...
export default function SFXModule() {
  ...
  const generate = useCallback(async () => {
    ...
    setNotice(`Recipe generated — "${result.recipe.soundName}"`)
  ...
  return (
    <div style={S.page}>
      <div style={S.header}>
        ...
        <p style={S.subtitle}>Describe your sound effect — DeepSeek designs the Roblox SoundService setup and Lua code automatically.</p>
      </div>
          ...
          <div style={S.card}>
            ...
            <div style={{ display: 'grid', gap: 12 }}>
              ...
              <button
                ...
                onClick={generate}
              >
                {busy ? 'Generating…' : 'Generate SFX Recipe'}
              </button>
            </div>
          </div>
        </aside>
        ...
        <main style={S.main}>
          ...
          {!recipe && !busy && (
            <div style={{ ...S.card, color: '#555b6e', fontSize: 13, lineHeight: 1.7, padding: 20 }}>
              <div style={{ fontSize: 15, fontWeight: 700, color: '#2e3340', marginBottom: 8 }}>🔊 Waiting for input</div>
              ...
              <div style={S.card}>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: 10 }}>
                  {[
                    ...
                    ['Roll Off', `${recipe.rollOffMinDistance}–${recipe.rollOffMaxDistance} studs`]
                  ].map(([k, v]) => (
